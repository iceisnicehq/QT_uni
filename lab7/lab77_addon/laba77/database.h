...
public:
    ...
    Q_INVOKABLE QVariantList searchBooksCombined(
        const QString &author,
        const QString &genre,
        int yearFrom,
        int yearTo,
        int availabilityFilter);
    Q_INVOKABLE QVariantList getAvailableBooks(const QString &searchTerm = "");
    ...
    Q_INVOKABLE bool returnBook(int loanId);
    Q_INVOKABLE QVariantList getAllLoans();
