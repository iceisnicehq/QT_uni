...
namespace {
struct qt_meta_tag_ZN17ProgressIndicatorE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN17ProgressIndicatorE = QtMocHelpers::stringData(
    "ProgressIndicator"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17ProgressIndicatorE[] = {
...
Q_CONSTINIT const QMetaObject ProgressIndicator::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17ProgressIndicatorE.offsetsAndSizes,
    qt_meta_data_ZN17ProgressIndicatorE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17ProgressIndicatorE_t,
        // Q_OBJECT / Q_GADGET
...
void *ProgressIndicator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17ProgressIndicatorE.stringdata0))
