...
static constexpr auto qt_meta_stringdata_ZN21DeviceSelectionDialogE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21DeviceSelectionDialogE[] = {
...
Q_CONSTINIT const QMetaObject DeviceSelectionDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21DeviceSelectionDialogE.offsetsAndSizes,
    qt_meta_data_ZN21DeviceSelectionDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21DeviceSelectionDialogE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DeviceSelectionDialog, std::true_type>,
...
void DeviceSelectionDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DeviceSelectionDialog::*)(const QString & );
            if (_q_method_type _q_method = &DeviceSelectionDialog::deviceSelected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *DeviceSelectionDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21DeviceSelectionDialogE.stringdata0))
...
// SIGNAL 0
void DeviceSelectionDialog::deviceSelected(const QString & _t1)
{
